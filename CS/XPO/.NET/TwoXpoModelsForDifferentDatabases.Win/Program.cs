...
static class Program {
    ...
    public static int Main(string[] args) {
        ...
        if(ConfigurationManager.ConnectionStrings["ConnectionString0"] != null) {
            connectionString = ConfigurationManager.ConnectionStrings["ConnectionString0"].ConnectionString;
        }
#if EASYTEST
