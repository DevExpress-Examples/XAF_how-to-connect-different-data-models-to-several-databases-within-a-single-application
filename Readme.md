<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/128588378/25.2.1%2B)
...
> **Note** 
> For information on how to achieve the same functionality with XPO on .NET and .NET Framework, see the **Readme.md** files in the respective solution folders:
>
> [.NET](https://github.com/DevExpress-Examples/XAF_how-to-connect-different-data-models-to-several-databases-within-a-single-application/tree/23.1.2%2B/CS/XPO/.NET) 
>
